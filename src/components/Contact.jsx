...
const Contact = () => {
  ...
  const btnGradient =
    status === "success"
      ...
      : status === "error"
        ...
        : status === "loading"
          ? isDark
            ? "from-gray-700 to-gray-500 opacity-60"
            : "from-pink-600 to-indigo-600 opacity-60"
          : isDark
  ...
  return (
    <section
      className="relative scroll-mt-24 py-20 px-6 md:px-24 lg:px-40 overflow-hidden bg-transparent"
      id="contact"
    >
      {/* Background glows */}
      <div
        className={`absolute top-1/2 left-[-10%] w-72 h-72 rounded-full blur-[120px] pointer-events-none ${isDark ? "bg-gray-500/5" : "bg-pink-600/10"}`}
      />
      <div
        className={`absolute bottom-10 right-[-5%] w-80 h-80 rounded-full blur-[150px] pointer-events-none ${isDark ? "bg-gray-400/5" : "bg-indigo-600/10"}`}
      />
      ...
      <div className="flex flex-col gap-16 relative z-10">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          >
            Have a question or a proposal? Drop a message below and I'll get
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div
              className={`absolute inset-0 blur-[80px] rounded-full animate-pulse ${isDark ? "bg-white/5" : "bg-pink-500/20"}`}
            />
            <motion.img
              animate={{ y: [0, -15, 0] }}
          ...
          >
            ...
            <div
              className={`relative z-10 backdrop-blur-2xl border p-8 md:p-12 rounded-4xl shadow-2xl transition-all duration-500
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-8 tracking-tight flex items-center gap-3">
                Send a Message
                <span
                  className={`grow h-px max-w-[60px] ${isDark ? "bg-gray-700" : "bg-pink-500/40"}`}
                />
              </h2>
                ...
                <AnimatedField icon={User} label="Name" isDark={isDark}>
                  <motion.input
                    ...
                    className={`w-full pl-10 pr-4 py-4 rounded-xl border focus:outline-none focus:ring-1 transition-all duration-300
                      ${
                        isDark
                          ? "bg-[#121212] border-white/10 text-white placeholder-gray-600 focus:border-gray-500 focus:ring-gray-500/30"
                  ...
                  whileHover={
                    status === "idle"
                      ? {
                          scale: 1.02,
                          boxShadow: isDark
                            ? "0 0 24px rgba(156,163,175,0.25)"
                            : "0 0 28px rgba(219,39,119,0.45)",
                        }
                      : {}
                  }
